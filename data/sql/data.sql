...
# Database: thinkcmf5
# Generation Time: 2017-10-07 09:14:02 +0000
# ************************************************************
...
# Dump of table cmf_deal_d0
# ------------------------------------------------------------

DROP TABLE IF EXISTS `cmf_deal_d0`;

CREATE TABLE `cmf_deal_d0` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `lsid` char(20) DEFAULT NULL COMMENT '流水号',
  `qyjg` char(50) DEFAULT NULL COMMENT '签约机构',
  `postype` char(50) DEFAULT NULL COMMENT 'pos类型',
  `shid` char(20) DEFAULT NULL COMMENT '商户号',
  `shname` char(100) DEFAULT NULL COMMENT '商户注册名',
  `time` char(20) DEFAULT NULL COMMENT '提款日期',
  `coin` float DEFAULT NULL COMMENT '提款金额',
  `fee` float DEFAULT NULL COMMENT '手续费',
  `realcoin` float DEFAULT NULL COMMENT '实扣费',
  `transtype` char(10) DEFAULT NULL COMMENT '交易类型',
  `state` tinyint(2) DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='交易D0表';
