...
class SettingController extends AdminBaseController
{
    ...
    public function coin()
    {
        ...
        $gjuserSetings    = cmf_get_option('gjuser_settings');
          

        $this->assign("ptuser", $ptuserSettings);
        $this->assign("gjuser", $gjuserSetings);

        return $this->fetch();
    }

    public function coinPost()
    {
        if ($this->request->isPost()) {
            

            $options = $this->request->param('options/a');
            $goptions = $this->request->param('goptions/a');
            cmf_set_option('ptuser_settings',$options);
            cmf_set_option('gjuser_settings',$goptions);
